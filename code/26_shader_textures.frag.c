...
#define uniform                __attribute__((address_space(398)))
...
typedef struct __attribute__((address_space(398))) __shady_builtin_sampler2D* sampler2D;

vec4 texture2D(sampler2D, vec2) __asm__("shady::prim_op::sample_texture");
